...
RELEASE_FILES=*.md *.txt

# For RPM and DNF packages:
SOFTWARE_DESCRIPTION=Create, modify, and extract Xbox/Xbox 360 XISOs.
YOUR_NAME=In
WEBSITE=https://github.com/alex-free/extract-xiso
LICENSE=CUSTOM
...
COMPILER_FLAGS_HOST=-Wall -Wextra -pedantic -static
